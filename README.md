...
Android app that wraps **https://kisaindonesia.id/** and bridges native device
...
App name: **Kisa**  •  Package: `id.kisaindonesia.mobile`
...
1. Install Android Studio, then `File > Open` and select this **KisaApp** folder.
...
keytool -genkey -v -keystore kisa.jks -keyalg RSA -keysize 2048 \
        -validity 10000 -alias kisa
