...
- IMPORTANT: do **not** upload `kisa.jks` or the `.base64.txt` file.
...
| Secret name        | Value                                              |
|--------------------|----------------------------------------------------|
| KEYSTORE_BASE64    | the full contents of `kisa.jks.base64.txt`    |
| KEYSTORE_PASSWORD  | `kisa2026`                                    |
| KEY_ALIAS          | `kisa`                                         |
| KEY_PASSWORD       | `kisa2026`                                    |
...
```bash
keytool -genkeypair -v -keystore kisa.jks -alias kisa \
  -keyalg RSA -keysize 2048 -validity 10000
# then: base64 -w0 kisa.jks   -> paste into the KEYSTORE_BASE64 secret
```
